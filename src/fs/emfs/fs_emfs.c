...
static MDS_FileOffset_t EMFS_Read(MDS_FileDesc_t *fd, uint8_t *buff, MDS_FileSize_t len,
...
static MDS_FileOffset_t EMFS_Write(MDS_FileDesc_t *fd, const uint8_t *buff, MDS_FileSize_t len,
                                   MDS_FileOffset_t *pos)
{
    size_t write = 0;
    MDS_EMFS_FileDesc_t *emfd = (MDS_EMFS_FileDesc_t *)(fd->node->data);
...
static MDS_FileOffset_t EMFS_Seek(MDS_FileDesc_t *fd, MDS_FileOffset_t pos,
