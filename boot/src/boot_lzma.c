...
#if (defined(MDS_BOOT_UPGRADE_ALLOC) && (MDS_BOOT_UPGRADE_ALLOC > 0))
...
MDS_BOOT_Result_t MDS_BOOT_UpgradeLzma(MDS_BOOT_Device_t *dst, MDS_BOOT_Device_t *src, uint32_t srcOfs,
                                       uint32_t srcSize)
{
