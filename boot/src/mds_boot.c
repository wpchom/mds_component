...
#ifndef MDS_BOOT_UPGRADE_SIZE
#define MDS_BOOT_UPGRADE_SIZE 1024
#endif

#ifndef MDS_BOOT_UPGRADE_HASH
#define MDS_BOOT_UPGRADE_HASH 1
#endif
...
static uint8_t g_bootCheckBuff[MDS_BOOT_UPGRADE_SIZE];
...
{
#if (defined(MDS_BOOT_UPGRADE_HASH) && (MDS_BOOT_UPGRADE_HASH > 0))
