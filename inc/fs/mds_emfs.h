...
/* Function ---------------------------------------------------------------- */
MDS_Err_t MDS_EMFS_Mkfs(DEV_STORAGE_Periph_t *device, size_t sctsz);
...
MDS_Err_t MDS_EMFS_FileSize(MDS_EMFS_FileDesc_t *fd, size_t *datasz, size_t *size);
...
MDS_Err_t MDS_EMFS_FileRead(MDS_EMFS_FileDesc_t *fd, intptr_t ofs, uint8_t *buff, size_t size,
                            size_t *read);
