...
/* Define ------------------------------------------------------------------ */
#ifndef MDS_FILESYSTEM_WITH_FULL
#define MDS_FILESYSTEM_WITH_FULL 0
#endif
...
enum MDS_FileOpenFlag {
    MDS_FILE_OFLAG_NONE = 0x0000U,
    MDS_FILE_OFLAG_RDONLY = 0x0001U,
    MDS_FILE_OFLAG_WRONLY = 0x0002U,
    MDS_FILE_OFLAG_RDWR = 0x0003U,
    MDS_FILE_OFLAG_OPEN = 0x0008U,

    MDS_FILE_OFLAG_APPEND = 0x0010U,
    MDS_FILE_OFLAG_EXCL = 0x0020U,
    MDS_FILE_OFLAG_CREAT = 0x0040U,
    MDS_FILE_OFLAG_TRUNC = 0x0080U,
};
...
typedef struct MDS_FileNode MDS_FileNode_t;
...
typedef struct MDS_FileSystemOps {
    ...
    MDS_FileOffset_t (*read)(MDS_FileDesc_t *fd, uint8_t *buff, MDS_FileSize_t len,
                             MDS_FileOffset_t *pos);
    MDS_FileOffset_t (*write)(MDS_FileDesc_t *fd, const uint8_t *buff, MDS_FileSize_t len,
                              MDS_FileOffset_t *pos);
    MDS_FileOffset_t (*seek)(MDS_FileDesc_t *fd, MDS_FileOffset_t pos, MDS_FileWhence_t whence);
...
#define MDS_FILE_SYSTEM_EXPORT(ops)                                                               \
    __attribute__((used, section(MDS_FILE_SYSTEM_SECTION))) static const MDS_FileSystemOps_t      \
        *__FsOps_##ops##__ = &(ops);
...
/* Function ---------------------------------------------------------------- */
#if (defined(MDS_FILESYSTEM_WITH_FULL) && (MDS_FILESYSTEM_WITH_FULL != 0))
void *MDS_FileSystemMalloc(size_t size);
void MDS_FileSystemFree(void *ptr);
...
MDS_Err_t MDS_FileSystemStatfs(const char *path, MDS_FsStat_t *stat);
#endif
...
/* FileSystem -------------------------------------------------------------- */
extern const MDS_FileSystemOps_t G_FILESYSTEM_EMFS_OPS;
